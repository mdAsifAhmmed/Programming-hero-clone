  ...
  return (
    <section className="dark:bg-gray-800">
      <div className=" container m-auto">
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 place-items-center py-24 px-3">
          <div className="col-span-1">
            <img src="/img/jankar.png" alt="" />
          </div>
          <div className="col-span-1 dark:text-gray-50">
            <h1 className="font-bold my-8 text-2xl dark:text-gray-50 text-gray-800">ঝংকার মাহবুব</h1>
